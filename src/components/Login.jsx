...
export default function Login(props) {
    ...
    <div className="text-center p-4 bg-white rounded-lg shadow-lg w-full max-w-md mx-auto h-80 items-center mt-16">
        ...
        <form form onSubmit={handleSubmit} className="max-w-md mx-auto">
            ...
            <label htmlFor="username" className="block text-gray-
            700">Username:</label>
            ...
            <button
                type="submit"
                className="w-full bg-blue-500 hover:bg-blue-600 text-white font-
                semibold py-2 px-4 rounded focus:outline-none focus:ring focus:border-blue-
                300"
            >
                Login
            </button>
